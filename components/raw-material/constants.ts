    ...
    subfields: [
      {
        name: "Polyethylene",
        description:
          "Polyethylene increased 310 Yuan/MT or 4.06% since the beginning of 2023, according to trading on a contract for difference (CFD) that tracks the benchmark market for this commodity.",
      },
      {
        name: "Polyvinyl",
        description:
          "Polyvinyl increased 150 Yuan/MT or 1.90% since the beginning of 2023, according to trading on a contract for difference (CFD) that tracks the benchmark market for this commodity.",
      },
      {
        name: "Polypropylene",
        description:
          "Polypropylene increased 400 Yuan/MT or 5.26% since the beginning of 2023, according to trading on a contract for difference (CFD) that tracks the benchmark market for this commodity.",
      },
    ],
  },
  {
